...
### Пожалуйста, используйте разборы задач только для самопроверки. Ваш навык решения задач зависит только от вас самих.
...
## 14 Оптимизация по двум параметрам
...
---
Все права принадлежат оригинальным авторам материалов.
Условия и разборы задач взяты из ознакомительных материалов на сайте https://kpolyakov.spb.ru/
